...
public static class VorwaertsschnittProtokoll
{
    private static readonly string     VorlageName = "Vorwaertsschnitt_Protokoll.xml";
    private static readonly CultureInfo IC          = CultureInfo.InvariantCulture;

    public static void Schreiben(
        VorwaertsschnittErgebnis        erg,
        ...
        string                          neupunkt)
    {
        ...
        try
        {
            ...
            string zielPfad = Path.Combine(verzeichnis,
                $"Vorwaertsschnitt_{jetzt:yyyy-MM-dd_HH-mm-ss}.rtf");
    ...
    private static Dictionary<string, string> BaueFelder(
        VorwaertsschnittErgebnis erg, string neupunkt, DateTime zeitpunkt)
    {
        ...
        List<VorwaertsschnittMessung>  messungen)
    {
        ...
        foreach (var m in messungen)
        {
            ...
            double t_gon = ((m.Hz + m.z) % 400 + 400) % 400;
